...
const HERB_NAME_TO_ID: Record<string, string> = {
  ...
  valerian: "herb_tagar",
  musta: "herb_musta",
  nagarmotha: "herb_musta",
  haritaki: "herb_haritaki",
  harad: "herb_haritaki",
  bibhitaki: "herb_bibhitaki",
  baheda: "herb_bibhitaki",
  sariva: "herb_sariva",
  anantamool: "herb_sariva",
  chirata: "herb_chirata",
  chirayita: "herb_chirata",
  ajwain: "herb_ajwain",
  carom: "herb_ajwain",
  jeera: "herb_jeera",
  cumin: "herb_jeera",
  kalonji: "herb_kalonji",
  "black seed": "herb_kalonji",
  "nigella": "herb_kalonji",
  isabgol: "herb_isabgol",
  psyllium: "herb_isabgol",
  senna: "herb_senna",
  "safed musli": "herb_safed_musli",
  kapikacchu: "herb_kapikacchu",
  mucuna: "herb_kapikacchu",
  "velvet bean": "herb_kapikacchu",
  rasna: "herb_rasna",
  lodhra: "herb_lodhra",
