...
-- 3. Seed data for clinically documented interactions
...
CREATE INDEX idx_hhi_herb1 ON herb_herb_interactions(herb_id_1);
CREATE INDEX idx_hhi_herb2 ON herb_herb_interactions(herb_id_2);
CREATE INDEX idx_hhi_severity ON herb_herb_interactions(severity);

-- ============================================
-- AGE-BASED HERB RESTRICTIONS
-- ============================================

CREATE TABLE herb_age_restrictions (
    id              UUID PRIMARY KEY DEFAULT gen_random_uuid(),
...
CREATE INDEX idx_har_herb ON herb_age_restrictions(herb_id);
CREATE INDEX idx_har_age ON herb_age_restrictions(age_group);
