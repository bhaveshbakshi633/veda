      ...
      <div className="shrink-0 bg-white rounded-2xl px-5 py-4 shadow-sm border border-gray-100 mb-4">
        <div className="flex items-center justify-between">
          ...
          <div className="flex gap-2 items-center">
            {/* voice mode toggle — only show if STT supported */}
            {sttSupported && (
              <button
            ...
            >
              {msg.role === "assistant" ? (
                <div className="space-y-2">
                  ...
                  {/* speak button — on completed messages */}
                  {msg.content && !(sending && i === messages.length - 1) && (
                    <button
                      onClick={() => speakText(msg.content)}
                      disabled={speaking}
                      className="mt-1 p-1.5 text-gray-300 hover:text-ayurv-primary transition-colors rounded-lg hover:bg-ayurv-primary/5"
