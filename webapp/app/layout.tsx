...
export const metadata: Metadata = {
  ...
  metadataBase: new URL(process.env.NEXT_PUBLIC_APP_URL || "https://webapp-self-rho.vercel.app"),
...
export default function RootLayout({ children }: { children: React.ReactNode }) {
  return (
    <html lang="en">
      <head>
        <link rel="dns-prefetch" href="https://hlzwtzacdjrnawyzhqha.supabase.co" />
        <link rel="preconnect" href="https://hlzwtzacdjrnawyzhqha.supabase.co" crossOrigin="anonymous" />
      </head>
      <body className={`${inter.variable} font-sans bg-ayurv-bg text-gray-900 pb-16 min-h-screen`}>
